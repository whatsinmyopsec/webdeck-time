...
/* harmony import */var _home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! /home/runner/work/webdeck-time/webdeck-time/node_modules/@rspack/core/node_modules/@module-federation/webpack-bundler-runtime/dist/index.cjs.js */"426");
/* harmony import */var _home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0__);

const __module_federation_runtime_plugins__ = [];
const __module_federation_remote_infos__ = {};
const __module_federation_container_name__ = "webdeck_time";
...
if (__webpack_require__.initializeSharingData || __webpack_require__.initializeExposesData) {
    ...
    early(__webpack_require__, "federation", ()=>(_home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default()));
    ...
    override(__webpack_require__, "S", (_home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().bundlerRuntime.S));
    if ((_home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().attachShareScopeMap)) _home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().attachShareScopeMap(__webpack_require__);
    override(__webpack_require__.f, "remotes", (chunkId, promises)=>_home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().bundlerRuntime.remotes({
            chunkId,
            promises,
    ...
    override(__webpack_require__.f, "consumes", (chunkId, promises)=>_home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().bundlerRuntime.consumes({
            chunkId,
            promises,
    ...
    override(__webpack_require__, "I", (name, initScope)=>_home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().bundlerRuntime.I({
            shareScopeName: name,
            initScope,
    ...
    override(__webpack_require__, "initContainer", (shareScope, initScope, remoteEntryInitOptions)=>_home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().bundlerRuntime.initContainerEntry({
            shareScope,
            initScope,
            remoteEntryInitOptions,
    ...
    (_home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().instance) = _home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().runtime.init((_home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().initOptions));
    if ((_m = __webpack_require__.consumesLoadingData) === null || _m === void 0 ? void 0 : _m.initialConsumes) _home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().bundlerRuntime.installInitialConsumes({
        webpackRequire: __webpack_require__,
        installedModules: consumesLoadinginstalledModules,
        initialConsumes: __webpack_require__.consumesLoadingData.initialConsumes,
        moduleToHandlerMapping: (_home_runner_work_webdeck_time_webdeck_time_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().consumesLoadingModuleToHandlerMapping)
    });
}
}),
...
!function() {
var map = {"104@": ["987"], "358@./Plugin": ["281"], "44@": ["987", "281"], "458@": ["512"], "537@0:21": ["281", "425"], "710@": ["512"]};
...
__webpack_require__.initializeSharingData = { scopeToSharingDataMapping: { "default": [{ name: "react-dom", version: "18.2.0", factory: function() { return __webpack_require__.el("44@").then(function() { return function() { return __webpack_require__(/*! /home/runner/work/webdeck-time/webdeck-time/node_modules/react-dom/index.js */"935"); }; }); }, eager: 0 }, { name: "react", version: "18.2.0", factory: function() { return __webpack_require__.el("458@").then(function() { return function() { return __webpack_require__(/*! /home/runner/work/webdeck-time/webdeck-time/node_modules/react/index.js */"294"); }; }); }, eager: 0 }] }, uniqueName: "webdeck-time" };
...
var dataWebpackPrefix = "webdeck-time:";
...
__webpack_require__.consumesLoadingData = { chunkMapping: {"281":["710"],"512":[],"425":["104"],"987":[]}, moduleIdToConsumeDataMapping: { "104": { shareScope: "default", shareKey: "react-dom", import: "react-dom", requiredVersion: "^18.2.0", strictVersion: false, singleton: true, eager: false, fallback: function() { return __webpack_require__.el("104@").then(function() { return function() { return __webpack_require__(/*! react-dom */"935"); }; }); } }, "710": { shareScope: "default", shareKey: "react", import: "react", requiredVersion: "^18.2.0", strictVersion: false, singleton: true, eager: false, fallback: function() { return __webpack_require__.el("710@").then(function() { return function() { return __webpack_require__(/*! react */"294"); }; }); } } }, initialConsumes: [] };
...
var chunkLoadingGlobal = self["webpackChunkwebdeck_time"] = self["webpackChunkwebdeck_time"] || [];
